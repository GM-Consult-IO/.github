# [![Github Repo](https://github.com/SixSense-Systems/.github/blob/main/.img/LOGO_24.png)](https://github.com/SixSense-Systems)  **SixSense Systems**
...
The [SixSense Systems](https://github.com/SixSense-Systems) repositories are not open-source but subject to the [license terms](https://github.com/SixSense-Systems/.github/blob/main/profile/LICENSE.md) unless expressly noted otherwise. *Please secure the IP that you download and do not share it unless permission has been obtained.*

All these repositories form part of commercial products and development of the codebase must contribute towards the commercial objectives and the feature roadmap of the [SixSense Systems](https://github.com/SixSense-Systems) product manager(s). Pull requests will only be considered if they are on the approved product backlog. *Before forking any repository and starting work on it, approval must be obtained from the administrator for the new features or changes.*

Contributors to the [SixSense Systems](https://github.com/SixSense-Systems) codebase should follow these guidelines to ensure that the codebase remains consistent. 
...
* The [PlatformIO](https://platformio.org/) project structure must be used for all libraries. When starting a new library, use the SixSense Systems [PioTemplate.h](https://github.com/SixSense-Systems/PioTemplate/blob/main/lib/PioTemplate/include/PioTemplate.h).
...
All libraries that provide an interface with another device and/or peripheral should implement the `SixSense::Device` and `SixSense::iConfiguration` interfaces. See the [example below](#code-example).
  ...
  1. Ensure that `platformio.ini` has [https://github.com/SixSense-Systems/SixSense.git](https://github.com/SixSense-Systems/SixSense.git) in the `lib_deps` section.
 ...
 * 
 * https://github.com/SixSense-Systems/.github/blob/main/profile/LICENSE.md)
 * 
 */
...
All SixSense Systems repositories are Copyright 2024, *GM Consolidated Holdings Pty Ltd*, ALL RIGHTS RESERVED, and subject to the [license terms](https://github.com/SixSense-Systems/.github/blob/main/profile/LICENSE.md) unless expressly noted otherwise.
 

## References
* [PioTemplate repo on github](https://github.com/SixSense-Systems/PioTemplate)
